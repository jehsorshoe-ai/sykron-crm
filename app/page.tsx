...
const initialDeals: Deal[] = [
  { id: 1, company: "Metalúrgica Santa Rita", title: "Diagnóstico de Qualidade e PCP", value: 4500, stage: "Lead novo", temperature: "Super quente", bucket: "Hoje", nextContact: "Hoje - primeiro contato", history: "Mapeamento industrial inicial.", person: "Jefferson", initials: "MS", color: "#00b9f2", due: "Hoje", tag: "Indústria", historyTimeline: "26/07/2026 - Lead adicionado - Etapa: Lead novo" },
  { id: 2, company: "Hospital Veterinário Sorocaba", title: "Controle de Retornos e Pacientes", value: 3200, stage: "Lead novo", temperature: "Quente", bucket: "3 dias", nextContact: "Em 3 dias - confirmar interesse", history: "Mapeamento veterinário 24h.", person: "Jefferson", initials: "HV", color: "#e9784d", due: "3 dias", tag: "Saúde", historyTimeline: "26/07/2026 - Lead adicionado - Etapa: Lead novo" },
  { id: 3, company: "Distribuidora de Autopeças Via Sul", title: "Painel Comercial e Estoque", value: 3800, stage: "Lead novo", temperature: "Quente", bucket: "3 dias", nextContact: "Em 3 dias - contato comercial", history: "Mapeamento comercial atacadista.", person: "Jefferson", initials: "VS", color: "#198f78", due: "3 dias", tag: "Comércio", historyTimeline: "26/07/2026 - Lead adicionado - Etapa: Lead novo" },
  { id: 4, company: "Isabela Rocha Estetica", title: "Controle simples de agenda e retornos", value: 1800, stage: "Lead novo", temperature: "Super quente", bucket: "Hoje", nextContact: "Hoje - enviar primeira mensagem", history: "Lead facil. WhatsApp publico.", person: "Jefferson", initials: "IR", color: "#bd6db5", due: "Hoje", tag: "Agenda", historyTimeline: "26/07/2026 - Lead adicionado - Etapa: Lead novo" },
  { id: 5, company: "Caninos Pet Shop", title: "Mini CRM de banho, tosa e pacotes", value: 2400, stage: "Lead novo", temperature: "Quente", bucket: "3 dias", nextContact: "Em 3 dias - confirmar interesse", history: "Negocio recorrente pet.", person: "Jefferson", initials: "CP", color: "#d59823", due: "3 dias", tag: "Follow-up", historyTimeline: "26/07/2026 - Lead adicionado - Etapa: Lead novo" },
  { id: 6, company: "Fino Faro Pet Shop", title: "Controle de delivery e recompra", value: 2200, stage: "Lead novo", temperature: "Morno", bucket: "7 dias", nextContact: "Em 7 dias - enviar exemplo visual", history: "Delivery e WhatsApp.", person: "Jefferson", initials: "FF", color: "#3c7dd9", due: "7 dias", tag: "Automacao", historyTimeline: "26/07/2026 - Lead adicionado - Etapa: Lead novo" },
  { id: 7, company: "CampoClin", title: "Indicadores de agenda e conversao", value: 3500, stage: "Lead novo", temperature: "Frio", bucket: "15 dias", nextContact: "Em 15 dias - retomar", history: "Clinica de especialidades.", person: "Jefferson", initials: "CC", color: "#bd6db5", due: "15 dias", tag: "Indicadores", historyTimeline: "26/07/2026 - Lead adicionado - Etapa: Lead novo" },
  { id: 8, company: "Vet Center Sorocaba", title: "Controle de retornos e servicos", value: 3200, stage: "Lead novo", temperature: "Bolsao", bucket: "30 dias", nextContact: "Em 30 dias - nutrir", history: "Clinica veterinaria 24h.", person: "Jefferson", initials: "VC", color: "#00b9f2", due: "30 dias", tag: "Retencao", historyTimeline: "26/07/2026 - Lead adicionado - Etapa: Lead novo" },
  { id: 9, company: "L.A English Idiomas & Musica", title: "Funil de aulas demonstrativas", value: 2100, stage: "Lead novo", temperature: "Super quente", bucket: "Hoje", nextContact: "Hoje - contato inicial", history: "Escola de idiomas.", person: "Jefferson", initials: "LA", color: "#e9784d", due: "Hoje", tag: "Funil", historyTimeline: "26/07/2026 - Lead adicionado - Etapa: Lead novo" }
];
...
const prospects: Prospect[] = [
  ...
  },
  {
    ...
    message: "Oi, tudo bem? Vi que voces trabalham com pet shop, banho e tosa e delivery. A Sykron helps negocios locais a organizar pedidos, agendamentos e retornos de clientes em um controle simples. Posso te mandar uma sugestao bem pratica para facilitar a rotina do WhatsApp?",
  },
  {
